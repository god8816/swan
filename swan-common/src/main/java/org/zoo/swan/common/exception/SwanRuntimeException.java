...
public class SwanRuntimeException extends RuntimeException {
     ...
     */
    public SwanRuntimeException(final String message) {
        super(message);
    }
     ...
     */
    public SwanRuntimeException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause the cause
     */
    public SwanRuntimeException(final Throwable cause) {
        super(cause);
    }
}
